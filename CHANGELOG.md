...
All notable changes to `agi-forecast` are documented in this file.
...
- chore(deps): bump actions/checkout, actions/setup-node, pnpm/action-setup
...
- feat(runtime): Forecast Gauge — 12 base + 3 derived + 4 safety gauges
- chore: add SECURITY, CONTRIBUTING, CODE_OF_CONDUCT
- chore(citation): add canonical contact email
- feat(scaffold): initial README, CITATION.cff, scorecard workflow
