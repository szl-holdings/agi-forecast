...
**PGP:** Optional — if you require encrypted communication, request the maintainer's public key via the email above.
...
- Authentication, authorization, data handling, and cryptographic implementations (gauge provenance hashing, forecast receipt generation, Brier-score ledger integrity).
